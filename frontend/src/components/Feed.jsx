...
function Feed() {
  ...
  return (
    <div className="lg:w-[50%] w-full bg-green-900 min-h-[100vh]   lg:h-[100vh] relative lg:overflow-y-auto ">
      ...
      <div className="w-full min-h-[100vh] flex flex-col items-center gap-[20px] p-[10px] pt-[40px]  bg-green-100 rounded-t-[60px] relative pb-[120px]">
        <Nav />
