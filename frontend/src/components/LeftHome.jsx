...
const {notificationData}=useSelector(state=>state.user)
  ...
  return (
    <div className={`w-[25%] hidden lg:block h-[100vh] bg-green-900 border-r-2 border-green-300 ${showNotification?"overflow-hidden":"overflow-auto"}`}>
      <div className='w-full h-[100px] flex items-center justify-between p-[20px] bg-gradient-to-r from-white/20 via-purple-400/20 to-pink-300/30 backdrop-blur-lg'>
      ...
      {!showNotification && <>
<div className='flex items-center w-full justify-between gap-[10px] px-[10px] border-b-2 border-green-300 py-[10px]'>
        <div className='flex items-center gap-[10px]'>
<div className='w-[70px] h-[70px] border-2 border-green-300 rounded-full cursor-pointer overflow-hidden'>
