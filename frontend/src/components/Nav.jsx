...
function Nav() {
  ...
  return (
    <div className='w-[90%] lg:w-[40%] h-[80px] bg-green-900 flex justify-around items-center fixed bottom-[20px] rounded-full shadow-2xl shadow-[#000000] z-[100]'>
     ...
     <div className='w-[40px] h-[40px] border-2 border-green-300 rounded-full cursor-pointer overflow-hidden' onClick={()=>navigate(`/profile/${userData.userName}`)}>
