...
function Profile() {
  ...
  return (
    <div className="w-full min-h-screen bg-green-200">
      ...
      <div className="w-full h-[100px] flex items-center justify-center gap-[40px] md:gap-[60px] px-[20%] pt-[30px] text-black">
        <div>
          <div className="text-black text-[22px] md:text-[30px] font-semibold">
            {profileData?.posts.length}
          </div>
          <div className="text-[18px] md:text-[22px] text-[#000000c7]">
            Posts
          </div>
        </div>
        <div>
      ...
      <div className="w-full h-[80px] flex justify-center items-center gap-[20px] mt-[10px]">
        {profileData?._id == userData._id && (
          <button
            className="px-[10px] min-w-[150px] py-[5px] h-[40px] bg-green-100 cursor-pointer rounded-2xl"
      ...
      <div className="w-full min-h-[100vh]  flex justify-center">
        <div className="w-full max-w-[900px] flex flex-col items-center rounded-t-[30px] bg-green-100 relative gap-[20px] pt-[30px] pb-[100px]">
          {profileData?._id == userData._id && (
