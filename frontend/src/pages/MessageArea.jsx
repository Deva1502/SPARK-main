  ...
  return (
    <div className="w-full h-[100vh] bg-green-100 relative">
      <div className=" w-full flex items-center gap-[15px] px-[20px]  py-[10px] fixed top-0 z-[100] bg-green-100 ">
        <div className=" h-[80px]  flex items-center gap-[20px] px-[20px]">
          <MdOutlineKeyboardBackspace
            className="text-black cursor-pointer w-[25px]  h-[25px] "
            onClick={() => navigate(`/`)}
          />
        </div>
      ...
      <div className="w-full h-[80px] fixed bottom-0 flex justify-center items-center bg-green-100 z-[100]">
        <form
          className="w-[90%] max-w-[800px] h-[80%] rounded-full bg-green-200 flex items-center gap-[10px] px-[20px] relative"
        ...
        >
          ...
          <input
            type="text"
            placeholder="Message"
            className="w-full h-full px-[20px] text-[18px] text-black outline-0"
